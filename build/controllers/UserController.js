    ...
    deleteUsers(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                res.json(users);
                console.log("Usuários obliterados com sucesso!!");
                res.status(200).json({
                    status: 200,
                    message: "Usuários obliterados com sucesso!!"
                });
            }
            catch (error) {
                console.log(error);
                res.status(400).json({
                    message: "Erro ao obliterar Usuários: Destruição interceptada",
                });
                console.log("Erro ao obliterar Usuários: Destruição interceptada");
            }
        });
    }
}
